...
bool check_operator__onnx__relu__6(
    size_t                  n_input,
    ...
    { // check if input tensors have valid types
        ...
        valid &= check_operator_tensors("operator__onnx__relu__6 input",
                                         1,
                                         conditions,
                                         input);
    }
    { // check if output tensors have valid types
        ...
        valid &= check_operator_tensors("operator__onnx__relu__6 output",
                                         1,
                                         conditions,
                                         output);
    }
    { // check if attributes have valid types
        ...
        valid &= check_operator_attributes("operator__onnx__relu__6",
                                           0,
                                           conditions,
                                           attribute);
    }
    { // check if multiple tensors constrained by 'T' have same type
        ...
        valid &= check_operator_constraint("operator__onnx__relu__6 T",
                                           1,
                                           conditions_input,
                                           input,
                                           1,
