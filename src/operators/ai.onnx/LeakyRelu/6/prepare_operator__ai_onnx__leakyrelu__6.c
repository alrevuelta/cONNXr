...
)
{
    ...
    float default_alpha = 0.01;

    context_operator__ai_onnx__leakyrelu__6 *op_ctx = NULL;
    op_ctx = malloc(sizeof(context_operator__ai_onnx__leakyrelu__6));
    ...
    ctx->executer = resolve_operator__ai_onnx__leakyrelu__6(ctx);
