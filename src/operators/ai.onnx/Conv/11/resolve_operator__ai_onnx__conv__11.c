...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__DOUBLE: { executer = (operator_executer) &operator__ai_onnx__conv__11__T_tensor_double; break; }
case ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT: { executer = (operator_executer) &operator__ai_onnx__conv__11__T_tensor_float; break; }
case ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT16: { executer = (operator_executer) &operator__ai_onnx__conv__11__T_tensor_float16; break; }
    default: {
