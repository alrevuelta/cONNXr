...
operator_executer resolve_operator__onnx__relu__6(
  ...
  printf("Resolving relu");
    ...
    switch ( T ) {
        ...
        //case ONNX__TENSOR_PROTO__DATA_TYPE__DOUBLE: { executer = (operator_executer) &operator__onnx__relu__6__T_tensor_double; break; }
        ...
        default: {
            fprintf(stderr, "[relu] no matching type for constraint 'T' found!\n");
            break;
        }
    }
}
