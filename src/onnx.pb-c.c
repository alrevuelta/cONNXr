...
static const ProtobufCFieldDescriptor onnx__tensor_proto__field_descriptors[14] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(Onnx__TensorProto, has_data_location),
...
{
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(Onnx__TypeProto__Map, has_key_type),
...
static const ProtobufCEnumValue onnx__version__enum_values_by_number[7] =
{
  ...
  { "IR_VERSION", "ONNX__VERSION__IR_VERSION", 6 },
};
static const ProtobufCIntRange onnx__version__value_ranges[] = {
{0, 0},{0, 7}
};
static const ProtobufCEnumValueIndex onnx__version__enum_values_by_name[7] =
{
  { "IR_VERSION", 6 },
