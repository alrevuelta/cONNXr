...
{
  Onnx__ModelProto *model = openOnnxFile("../test/node/test_matmul_3d/model.onnx");
  Onnx__TensorProto *inp0 = openTensorProtoFile("../test/node/test_matmul_3d/test_data_set_0/input_0.pb");
  Onnx__TensorProto *inp1 = openTensorProtoFile("../test/node/test_matmul_3d/test_data_set_0/input_1.pb");
  Onnx__TensorProto *out1 = openTensorProtoFile("../test/node/test_matmul_3d/test_data_set_0/output_0.pb");
...
{
  Onnx__ModelProto *model = openOnnxFile("../test/node/test_matmul_4d/model.onnx");
  Onnx__TensorProto *inp0 = openTensorProtoFile("../test/node/test_matmul_4d/test_data_set_0/input_0.pb");
  Onnx__TensorProto *inp1 = openTensorProtoFile("../test/node/test_matmul_4d/test_data_set_0/input_1.pb");
  Onnx__TensorProto *out1 = openTensorProtoFile("../test/node/test_matmul_4d/test_data_set_0/output_0.pb");
