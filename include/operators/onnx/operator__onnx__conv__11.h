...
typedef struct operator_context_input__operator__onnx__conv__11 {
    size_t length;
    operator_tensor *X;
operator_tensor *W;
operator_tensor *B;
} operator_context_input_operator__onnx__conv__11;

typedef struct operator_context_output__operator__onnx__conv__11 {
    size_t length;
    operator_tensor *Y;
} operator_context_output_operator__onnx__conv__11;

typedef struct operator_context_attribute__operator__onnx__conv__11 {
    size_t length;
...
} operator_context_attribute_operator__onnx__conv__11;

typedef struct operator_context__operator__onnx__conv__11 {
    struct operator_context_input__operator__onnx__conv__11     *input;
    struct operator_context_output__operator__onnx__conv__11    *output;
    struct operator_context_attribute__operator__onnx__conv__11 *attribute;
    operator_executer                          operator;
} operator_context__operator__onnx__conv__11;
 ...
 * @since version 11
 *
 * @see ../../../../../../travis/build/onnx/wheel-builder/onnx/onnx/defs/nn/defs.cc:773
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#Conv
 */
operator_status operator__onnx__conv__11(
    operator_context__operator__onnx__conv__11 *ctx
);
