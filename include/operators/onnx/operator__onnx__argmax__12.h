 ...
 * along the provided axis. The resulting tensor has the same rank as the input
 * if keepdims equal 1. If keepdims equal 0, then the resulting tensor have the
 * reduced dimension pruned. If select_last_index is True (default False), the
 * index of the last occurrence of the max is selected if the max appears more
 * than once in the input. Otherwise the index of the first occurrence is
 * selected. The type of the output tensor is integer.
 * 
 * Constraint T:
 ...
 * @since version 12
 *
 * @see ../../../../../../travis/build/onnx/wheel-builder/onnx/onnx/defs/reduction/defs.cc:238
