 ...
 * system per se, like an Arduino. Depending on the size of the model, this
...
int main()
{
  ...
  unsigned int model_onnx_len = 26454;
  Onnx__ModelProto *test = NULL;
  test = onnx__model_proto__unpack(NULL,model_onnx_len,model_onnx);

  printf("%s\n", test->producer_name);
  printf("%s\n", test->producer_version);
  printf("%s\n", test->graph->name);
}
