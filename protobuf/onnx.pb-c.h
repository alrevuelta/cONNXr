...
typedef struct _Onnx__TensorAnnotation Onnx__TensorAnnotation;
...
typedef struct _Onnx__SparseTensorProto Onnx__SparseTensorProto;
...
typedef struct _Onnx__TypeProto__Sequence Onnx__TypeProto__Sequence;
typedef struct _Onnx__TypeProto__Map Onnx__TypeProto__Map;
...
#define ONNX__ATTRIBUTE_PROTO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&onnx__attribute_proto__descriptor) \
    , NULL, NULL, NULL, 0, ONNX__ATTRIBUTE_PROTO__ATTRIBUTE_TYPE__UNDEFINED, 0, 0, 0, 0, 0, {0,NULL}, NULL, NULL, NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL }
...
struct  _Onnx__TensorAnnotation
{
  ProtobufCMessage base;
  char *tensor_name;
  /*
...
#define ONNX__GRAPH_PROTO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&onnx__graph_proto__descriptor) \
    , 0,NULL, NULL, 0,NULL, 0,NULL, NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL }
...
#define ONNX__TENSOR_PROTO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&onnx__tensor_proto__descriptor) \
    , 0,NULL, 0, 0, NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, NULL, NULL, 0, {0,NULL}, 0,NULL, 0, ONNX__TENSOR_PROTO__DATA_LOCATION__DEFAULT, 0,NULL, 0,NULL }


/*
 * A serialized sparse-tensor value
 */
struct  _Onnx__SparseTensorProto
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  ONNX__TENSOR_SHAPE_PROTO__DIMENSION__VALUE_DIM_PARAM = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__TENSOR_SHAPE_PROTO__DIMENSION__VALUE)
 ...
 * repeated T
 */
struct  _Onnx__TypeProto__Sequence
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  ONNX__TYPE_PROTO__VALUE_MAP_TYPE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__TYPE_PROTO__VALUE)
...
#endif  /* PROTOBUF_C_onnx_2eproto__INCLUDED */
